...
//   void openWhatsAppGroupChat() async {
//     String phoneNumber = "923288898341"; // 03288898341
//     String message = "Hello! I want to join the trip 😊";
...
//                     ListTile(
//                       onTap: openWhatsAppGroupChat, // 🔗 CONNECTED
//                       leading: Container(
//                         height: 60,
//                         width: 60,
//                         decoration: BoxDecoration(
...
class _RequesttojoinTripDetailsState extends State<RequesttojoinTripDetails> {
  ...
  // ✅ MAIN FUNCTION: Firestore se guider ka number fetch + WhatsApp open
  Future<void> openWhatsAppWithGuider({
    required String guiderId,
    required String tripName,
  }) async {
    try {
      final guiderDoc = await FirebaseFirestore.instance
          .collection('guiders')
          .doc(guiderId)
          .get();
      ...
      if (!guiderDoc.exists) {
        ScaffoldMessenger.of(
          ...
          context,
        ).showSnackBar(const SnackBar(content: Text("Guider not found")));
        return;
      }

      final String phoneNumber = guiderDoc['phone'];

      final String message =
          "Hello! I want to join your trip 😊\nTrip: $tripName";
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        openWhatsAppWithGuider(
                          guiderId: trip.userId,
                          tripName: trip.location.toString(),
                        );
                      },
                      child: const Text(
                        'Join Trip',
                  ...
                  ListTile(
                    ...
                    subtitle: inter(
                      text: 'Chat directly with trip guider',
                      fontSize: 11,
                      color: AppColors.grey,
                      fw: FontWeight.w400,
                    ),
